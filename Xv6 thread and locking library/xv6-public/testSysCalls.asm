...
_testSysCalls:     file format elf32-i386
...
int main(){
   ...
   3:	83 e4 f0             	and    $0xfffffff0,%esp
    clone();
   6:	e8 08 03 00 00       	call   313 <clone>
    join();
   b:	e8 0b 03 00 00       	call   31b <join>
    return 0;
...
free(void *ap)
{
 ...
 581:	a1 0c 0a 00 00       	mov    0xa0c,%eax
{
 ...
 5c1:	5b                   	pop    %ebx
  freep = p;
 5c2:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
}
 5c8:	5e                   	pop    %esi
 5c9:	5f                   	pop    %edi
 5ca:	5d                   	pop    %ebp
 ...
 5f9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 5fc:	89 15 0c 0a 00 00    	mov    %edx,0xa0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 619:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 61c:	8b 3d 0c 0a 00 00    	mov    0xa0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 65f:	73 4f                	jae    6b0 <malloc+0xa0>
    ...
    if(p == freep)
 661:	8b 3d 0c 0a 00 00    	mov    0xa0c,%edi
 ...
 68a:	e8 f1 fe ff ff       	call   580 <free>
  return freep;
 68f:	8b 15 0c 0a 00 00    	mov    0xa0c,%edx
 ...
 6d7:	0a 00 00 
    base.s.size = 0;
 6da:	bf 10 0a 00 00       	mov    $0xa10,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 6e9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 6eb:	c7 05 14 0a 00 00 00 	movl   $0x0,0xa14
 6f2:	00 00 00 
    if(p->s.size >= nunits){
